    ...
    <nav className="bg-green-200 p-4 shadow-md">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          <img src="/path/to/logo.png" alt="NutriCheck" className="h-8" /> {/* Ganti dengan path logo kamu */}
          <span className="text-xl font-bold text-green-700">NutriCheck</span>
        </div>
        ...
        <div className="flex space-x-4">
          <a href="/login" className="bg-green-500 text-white px-4 py-2 rounded-full hover:bg-green-600 transition">Login</a>
