      ...
      <section className="pb-20">
        ...
        >
          ...
          <SwiperSlide>
            <div className="mt-20 px-10">
              <div className="bg-white py-4 mb-10 border-2 border-[#196D0D] rounded-4xl w-4/5 mx-auto text-center ">
                <h3 className="text-3xl font-bold text-[#196D0D]">Protein</h3>
              </div>
              <div className="max-w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {/* Yellow Category */}
                <div className="text-center bg-white py-10 px-10 mx-auto">
          ...
          <SwiperSlide>
            <div className="mt-20 px-10">
              <div className="bg-white py-4 mb-10 border-2 border-[#196D0D] rounded-4xl w-4/5 mx-auto text-center ">
                <h3 className="text-3xl font-bold text-[#196D0D]">Fats</h3>
              </div>
              <div className="max-w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {/* Yellow Category */}
                <div className="text-center bg-white py-10 px-10 mx-auto">
          ...
          <SwiperSlide>
            <div className="mt-20 px-10">
              <div className="bg-white py-4 mb-10 border-2 border-[#196D0D] rounded-4xl w-4/5 mx-auto text-center ">
                <h3 className="text-3xl font-bold text-[#196D0D]">Carbs</h3>
              </div>
              <div className="max-w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {/* Yellow Category */}
                <div className="text-center bg-white py-10 px-10 mx-auto">
