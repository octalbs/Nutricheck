    ...
    <div className="bg-[#CFEBD1]">
      ...
      <section className="py-35">
        <div className="flex justify-between items-center rounded-lg">
          <div className="w-1/2 text-center text-[#333] ml-10">
            ...
            {currentUser && <p className="text-xl text-[#196D0D] font-semibold mb-4">Hello, {currentUser.displayName || currentUser.email}! Ready to continue your health journey?</p>}
            <p className="text-2xl leading-8">
              Discover how to live a healthy life, monitor your progress, <br />
      ...
      <section className="bg-[#FDFAF6] pt-16 text-center">
        ...
        <div className="mt-6 flex justify-center space-x-6 mb-15">
          <div className="p-6 rounded-lg shadow-lg text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
            ...
            <p className="text-gray-600">
              Complete information about food <br />
          ...
          <div className="p-6 rounded-lg shadow-lg text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
            <div className="flex justify-start items-center mb-4">
              <img src="/assets/image/features-icon-2.png" alt="Track Icon" className="h-16 mr-4" />
              <h3 className="font-semibold">Track</h3>
            </div>
            <p className="text-gray-600">
              Track your health progress <br />
              with easy-to-use <br />
              and informative tracking tools.
            </p>
          </div>
          <div className="p-6 rounded-lg shadow-lg text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
            <div className="flex justify-start items-center mb-4">
              <img src="/assets/image/features-icon-3.png" alt="Education Icon" className="h-16 mr-4" />
              <h3 className="font-semibold">Education</h3>
            </div>
            <p className="text-gray-600">
              Access a variety of articles, <br />
        ...
        <div className="bg-[#CFEBD1] p-10">
          ...
          {currentUser ? (
            <Link to="/tracker" className="mt-6 bg-[#196D0D] text-white px-8 py-3 rounded-4xl text-xl hover:bg-[#155d07] transition-colors inline-block">
              Continue Journey!
            </Link>
          ) : (
            <Link to="/signup" className="mt-6 bg-[#196D0D] text-white px-8 py-3 rounded-4xl text-xl hover:bg-[#155d07] transition-colors inline-block">
              Join Now!
            </Link>
          )}
        </div>
